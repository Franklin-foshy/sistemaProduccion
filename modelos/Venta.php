...
public function insertar($idcliente,$idusuario,$tipo_comprobante,$serie_comprobante,$num_comprobante,$fecha_hora,$impuesto,$total_venta,$idarticulo,$cantidad,$precio_venta,$descuento){
	...
	//return ejecutarConsulta($sql);
	 ...
	 while ($num_elementos < count($idarticulo)) {
	 	...
	 	$sql_detalle="INSERT INTO detalle_venta(idventa,idarticulo,idproyecto,cantidad,precio_venta,descuento,idservicio) VALUES('$idventanew','$idarticulo[$num_elementos]',1,'$cantidad[$num_elementos]','$precio_venta[$num_elementos]','$descuento[$num_elementos]',5)";
