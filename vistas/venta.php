...
<div class="box-header with-border">
  <h1 class="box-title">Ventas <button class="btn btn-secondary" onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i>Agregar</button></h1>
  ...
  <form action="" name="formulario" id="formulario" method="POST">
    ...
    <div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-12">
     <a data-toggle="modal" href="#myModal">
       <button id="btnAgregarArt" type="button" class="btn btn-warning"><span class="fa fa-plus"></span>Agregar Articulos</button>
     </a>
    </div>
...
<div class="form-group col-lg-12 col-md-12 col-xs-12">
     <table id="detalles" class="table table-striped table-bordered table-condensed table-hover">
       <thead style="background-color:#FAFAD2">
        <th>Opciones</th>
        <th>Articulo</th>
        <th>Cantidad</th>
        <th>Precio Venta</th>
