...
<div class="box-header with-border">
  <h1 class="box-title">Agregar producto <button class="btn btn-secondary" data-toggle="modal" data-target="#articulo" onclick="mostrarform(true)" id="btnagregar"><i class="fa fa-plus-circle"></i>Agregar</button> <a target="_blank" href="../reportes/rptarticulos.php"><button class="btn btn-info">Reporte</button></a></h1>
...
<div class="modal fade" id="articulo" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
