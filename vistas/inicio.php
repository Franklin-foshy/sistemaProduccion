...
if ($_SESSION['inicio']==1) {
  ...
  //obtener valores para cargar al grafico
  ...
  $totalesc=substr($totalesc, 0,-1);
    ...
    //obtener valores para cargar al grafico de 
...
<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
  <div class="small-box bg-primary">
    ...
    <a href="extraccion.php" class="small-box-footer">Materia Prima ingresada <i class="fa fa-arrow-circle-right"></i></a>
  </div>
</div>
</div>
<div class="panel-body">
